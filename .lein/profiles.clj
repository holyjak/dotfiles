...
;;                        [clj-ns-browser "1.3.1"]
                       ...
                       [slamhound "1.5.4"] ;; optimize and add missing requires/imports in .clj files - see aliases below or editor-specific plugins or run from repl
...
;;                          [clj-ns-browser.sdoc sdoc]
        ...
        :plugins [
                  ...
                  [com.jakemccrary/lein-test-refresh "0.4.0"] ;; autotest: lein test-refresh :growl ; weak results reporting :-(
                  [lein-light "0.0.44"] ; LightTable: `lein light` in a prj
                  [jonase/eastwood "0.1.2"] ; linter: lein eastwood
                  [lein-pprint "1.1.1"]
                  ]
        :aliases {
